...
const workerBundles = [
  ...
  bundle("hub/dataSources/spadl/spadlWorker.ts", "hub$spadlWorker.js", false, false),
  bundle("hub/dataSources/teamlocation/teamLocationWorker.ts", "hub$teamLocationWorker.js", false, false),
